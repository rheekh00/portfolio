...
### [3. 금융 데이터 Factor 분석](https://github.com/rheekh00/quant-factor)
- **목표**: 한국, 미국, 일본의 주식 가격 데이터를 정제하고 factor의 유효성을 분석 및 검정
- **기술 스택**: Pandas, Numpy, Matplotlib
- **성과**:
  - 대형 가격 데이터의 정제 기준을 산술 및 기하 평균 수익률을 통해 제시
  - 투자의 유효한 factor 탐색 및 유효성 검증
  - 각 국가 주식 가격의 성격을 비교

### [4. Hidden Markov Models를 활용한 주식 가격 변동 예측](https://github.com/rheekh00/hmm-price-prediction)
...
### [5. Bayesian Optimization을 이용한 스마트 팩토리 장비 배치 최적화](https://github.com/rheekh00/bayesian-optimization)
...
### [6. Transformer 모델 최적화](https://github.com/rheekh00/transformer-performance-optimization)
...
### [7. YouTube Shorts Generator](https://github.com/rheekh00/youtube-shorts-generator)
...
### [8. 카드 사용내역 계정과목 분류기 개발](https://github.com/rheekh00/rag-expense-explainer)
...
### [9. MPI 및 CUDA를 활용한 gpt2 125M 모델의 대규모 데이터 병렬 처리 및 최적화](https://github.com/rheekh00/gpt2-parallel-optimization)
